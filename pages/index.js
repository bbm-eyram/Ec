...
export default function Home() {
  ...
  const totalImagesCount = Array.isArray(products) 
  ? products.reduce((total, product) => total + (product.images ? product.images.length : 0), 0) 
  : 0;
          ...
          <div className="mx-auto  px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
                ...
                <Link href={'https://ecommerce-frontend-ashen-five.vercel.app/'} target="_blank"
          ...
          <div className="h-32 rounded-lg bg-gray-200 flex items-center justify-center">
            ...
            >
              <div>
                ...
                <p className="text-2xl font-medium text-gray-900">GHc {formatPrice(totalPrice)}</p>
              </div>
